...
public class ToRedeploy {
    ...
    private final RedeployType redeployType;

    public ToRedeploy(String allocatingService, String username, RedeployType redeployType) {
    ...
    public ToRedeploy(String allocatingService, String username) {
        this(allocatingService, username, RedeployType.DEFAULT);
    }
